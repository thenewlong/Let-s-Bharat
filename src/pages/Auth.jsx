...
const Auth = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#02040a] flex items-center justify-center p-4 sm:p-6 md:p-8 font-sans overflow-y-auto md:overflow-hidden perspective-container">
      ...
      <div className="w-full max-w-5xl rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row h-auto md:min-h-[550px] border border-gray-800/50 bg-[#0a0a0a] card-3d-entrance my-auto">
        ...
        <div className="hidden md:flex w-full md:w-1/2 p-6 sm:p-8 md:p-10 flex-col justify-center md:justify-between relative overflow-hidden border-r border-gray-800/40">
          ...
          <div className="z-10 mt-2 mb-4 md:mt-8 md:mb-6">
            ...
            <p className="text-gray-400 mt-3 sm:mt-4 text-sm md:text-base max-w-sm leading-relaxed slide-up-fade" style={{animationDelay: "0.8s"}}>
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center relative" 
          ...
          <div className="max-w-sm w-full mx-auto bg-white/60 backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-xl border border-white/50 slide-up-fade" style={{animationDelay: "0.4s"}}>
            ...
            <div className="flex relative border-b border-gray-300/80 mb-6">
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {authMode === 'signup' && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/80 border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#f5a623] transition-all font-medium shadow-sm"
                  />
                </div>
              )}
              ...
              <button
                type="submit"
                className="w-full bg-[#f5a623] hover:bg-[#e0961b] text-white py-3 rounded-xl font-bold text-sm transition-all shadow-[0_4px_14px_0_rgba(245,166,35,0.39)] active:scale-[0.98] mt-4"
              >
            ...
            <button
              ...
              type="button"
              className="w-full bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 active:scale-[0.98] shadow-sm"
            >
