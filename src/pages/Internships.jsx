...
const Internship = () => {
  // Target Date Set: 10 September 2026
  const TARGET_DATE = new Date('2026-09-10T00:00:00').getTime();
  ...
  const handleNotifySubmit = (e) => {
    e.preventDefault();
    if (email) {
      // Yahan aap apna API ya Firebase ka code daal sakte hain email save karne ke liye
    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-center px-4 font-sans selection:bg-slate-200">
      ...
      >
        ...
        <motion.p variants={fadeUp} className="text-sm md:text-base text-slate-500 max-w-md md:max-w-lg leading-relaxed mb-8 font-medium">
          We're working behind the scenes to bring you the best internship opportunities. Stay tuned!
        </motion.p>

        <motion.p variants={fadeUp} className="text-sm md:text-base text-slate-500 mb-8 font-medium">
          Launching on <span className="font-bold text-slate-900">10 September 2026</span>
        </motion.p>
